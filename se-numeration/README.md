...
[Скачать / Установить / Переустановить](https://github.com/Eric-Draven/userscripts/raw/master/se-numeration/se-numeration.user.js) ( **v1.5b3** от **03.05.2018** )
...
### История версий
* **1.5b3** - скрипта больше не пытается пронумеровать пустую выдачу поисковиков, т.е. когда поисковик сообщеат: "**По данному запросу ничего не найдено**".
