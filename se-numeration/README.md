...
[Скачать / Установить / Переустановить](https://github.com/Eric-Draven/userscripts/raw/master/se-numeration/se-numeration.user.js) ( **v1.4.2** от **17.02.2018** )
...
### История версий
* **v1.4.2** - в поисковике **Mail.ru** скрыты навязчивые рекламные баннеры. Исправлена ошибка нумератора в поисковике **Yandex**.
