...
[Скачать / Установить / Переустановить](https://github.com/Eric-Draven/userscripts/raw/master/se-numeration/se-numeration.user.js) ( **v1.5b10** от **07.07.2018** )
...
### История версий
* **1.5b9** - на страницу выдачи поисковика **Yandex** добавлен переключатель, с помощью которого можно мгновенно отобразить/скрыть **Footer**.
* **1.5b8** - исправлены ошибки нумератора в поисковике **Yandex**.
* **1.5b7** - скрыта функция "**Включить ПЛЮС**" в поисковике **Yandex**.
* **1.5b6** - улучшена функция распознавания блоков **Яндекс.Директ** в поисковике **Yandex**.
* **1.5b4**:
