...
* **Mail.ru** - этот поисковик может выдавать даже 12 "хороших" позиций и скрипт в этом не виноват!
...
### История версий
* **v1.6.3**
  * исправлены ошибки нумератора в поисковике **Yandex**.
* **v1.6.2**:
  * после длительного отсутствия обновлений, восстановлена работа нумератора во многих поисковиках.
* **v1.6.1**:
