...
[Скачать / Установить](https://github.com/Eric-Draven/userscripts/raw/master/se-numeration/se-numeration.user.js) ( **v1.3.5** от **07.10.2017** )
...
### История версий
* **v1.3.5** - исправлены ошибки нумератора в поисковике **Google**.
...
* Работоспособность проверена в браузерах:
  ...
  * **Chrome v57-61** ( _Tampermonkey, Violentmonkey, MeddleMonkey_ )
  * **Яндекс.Браузер v17** ( _Tampermonkey, Violentmonkey, MeddleMonkey_ )
  * **Opera v44-48** ( _Tampermonkey, Violentmonkey_ )
