...
[Скачать / Установить](https://github.com/Eric-Draven/userscripts/raw/master/se-numeration/se-numeration.user.js) ( **v1.4** от **12.12.2017** )
...
### История версий
* **v1.4** - время выполнения скрипта сократилось на 150-200%. Добавлена поддержка **Greasemonkey 4.x**. 
...
* Работоспособность проверена в браузерах:
  * **Firefox v24-56** ( _Greasemonkey, Tampermonkey_ )
  * **Chrome v57-62** ( _Tampermonkey, Violentmonkey, MeddleMonkey_ )
  * **Яндекс.Браузер v17** ( _Tampermonkey, Violentmonkey, MeddleMonkey_ )
  * **Opera v44-49** ( _Tampermonkey, Violentmonkey_ )
